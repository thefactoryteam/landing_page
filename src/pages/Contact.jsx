...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Contact Us – The Factory</title>
        <meta name="description" content="Have questions or ideas? Reach out to The Factory HQ — we’d love to hear from you." />
        <link rel="canonical" href="https://techfactory.xyz/contact" />
      </Helmet>
