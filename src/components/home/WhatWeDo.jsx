...
const WhatWeDo = () => {
    ...
    return (
        <motion.div className="primary-font max-w-3/4 w-full mx-auto py-20" id="our-services">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <motion.div className="col-span-2 space-y-40 max-w-2xl">
                    ...
                    <motion.div initial="hidden" whileInView="visible" exit="exit" variants={textVariants}>
                        ...
                        <motion.p className="text-lg md:text-3xl font-bold leading-normal md:leading-tight py-3 md:py-7" variants={textVariants}>
                            JukeBox is The Factory's flagship 3-month incubator program, where we identify, nurture, and invest in early-stage startups.
                        </motion.p>
                        <motion.p className="text-lg md:text-xl text-gray-900 leading-normal md:leading-10" variants={textVariants}>
                        ...
                        <motion.button
                            whileHover="hover"
                            className="mt-5 py-2 px-6 bg-[#231F20] text-white group text-xs md:text-lg cursor-pointer rounded-full flex items-center gap-3 relative overflow-hidden"
                        >
                    ...
                    <motion.div initial="hidden" whileInView="visible" exit="exit" variants={textVariants}>
                        ...
                        <motion.p className="text-lg md:text-xl text-gray-900 leading-normal md:leading-tight" variants={textVariants}>
                    ...
                    <motion.div initial="hidden" whileInView="visible" exit="exit" variants={textVariants}>
                        ...
                        <motion.p className="text-lg md:text-xl text-gray-900 py-5" variants={textVariants}>
                            that employers want.
                        </motion.p>
                        <motion.div className="flex text-sm md:text-lg font-medium" variants={textVariants}>
                            <RiDoubleQuotesL className="text-[#2BE028] text-lg" />
