...
const sections = [
    ...
    },
    {
        id: "law",
      title: "Governing Law",
      term: "These Terms shall be governed by and construed in accordance with the laws of Cross River State/ Nigeria, without regard to its conflict of law provisions."
    },
    {
        id: "changes",
    ...
    },
    {
        id: "contact",
      title: "Contact Us",
      term: "If you have any questions about these Terms, please contact us at: 📧 info@techfactory.xyz 🌐 www.techfactory.xyz"
    }
  ]
        ...
        <section className="w-ful py-20 px-4 md:px-8 lg:px-16 primary-font">
            <div className="max-w-7xl mx-auto">
                <div className="flex px-4 py-12 relative">
                    ...
                    <div className="space-y-24 flex-1 ml-0 md:ml-[5rem]">
                        <motion.h1
