...
const OfferWorkspace = () => {
    return (
        <section className=" primary-font">
            {/* <div className=''> */}
            {offers.map(({ title, desc, features, benefits, image }, idx) => {
                return (
                    <div key={idx} className='p-14 max-w-5xl bg-[#e0e0e0] mx-auto border-2 rounded-xl border-dashed border-[#231F20] mb-[70px]'>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            {/* Text Section */}
                            <div className="">
                                <h2 className="text-3xl">{title} </h2>
                                <p className="text-[#231F20] text-xl py-5">
                                    {desc}
                                </p>

                                <div>
                                    <h3 className="font-bold text-black text-2xl">Features</h3>

                                    <ul className="pl5 space-y-2  text-[#231F20] text-xl py-5">
                                ...
                                <div>
                                    <h3 className="font-bold text-black text-2xl">Benefits</h3>
                                    <ul className="space-y-2 text-[#231F20] text-xl py-5">
