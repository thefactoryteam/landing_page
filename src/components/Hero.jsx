...
//         <motion.h1
//           className="primary-font font-black uppercase text-[121px] text-center leading-[1]"
//           initial="hidden"
//           animate="visible"
//           variants={{
...
//           <motion.span className="meriwether-font lowercase italic text-[#2BE028]" variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }}>Africa naija</motion.span>
//           <br />
